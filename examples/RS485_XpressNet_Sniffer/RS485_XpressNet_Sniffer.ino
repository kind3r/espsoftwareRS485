...
void setup() {
  //Setup RS485 for pin 2 TX and pin 4 RX
  RS485.setup(2, 4);
  //Set up on 62500 Baud with 9 bits
  RS485.begin(62500, 9);
  //Set RS485 TX/RX pin to 5 and invert (HIGH = receive, LOW = send)
  RS485.setTransmitEnablePin(5, true);

  Serial.begin(115200);
  // wait for esp to throw out it's garbage over Serial :)
  delay(1000);
  Serial.println("");
  Serial.println("");
